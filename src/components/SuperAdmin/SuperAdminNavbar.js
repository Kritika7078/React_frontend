        ...
        <Form className="d-flex" id='searchbar'>
          ...
          >
            <NavDropdown title="more options" className='nav-dropdown' id="navbarScrollingDropdown">
              <NavDropdown.Item href="#">Update Notaries</NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item href="#">Make Admin</NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item href="#">Remove Admin</NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item href="#">Update Admin</NavDropdown.Item>
            </NavDropdown>
          </Nav>
        </Navbar.Collapse>
      </Container>
